package tn.itdevspace.ptest01.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("tn.itdevspace.ptest01.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("tn.itdevspace.ptest01.security.DomainUserDetailsService", "createSpringSecurityUser");
