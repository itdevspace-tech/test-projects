...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'b5250ece-ce35-4c1c-8cfe-772404eaab60' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('84394c4c-5878-457b-b75f-6ed44068aadb');
      cy.get(`[data-cy="name"]`).should('have.value', '84394c4c-5878-457b-b75f-6ed44068aadb');
